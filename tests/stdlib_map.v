    ...
    Record signature `{_fargs : FArgs} {t : Set -> Set} : Type := {
      ...
      min_binding :
        forall {a : Set}
          ...
          t a -> Ord.(RocqOfOCaml.OCamlMap.OrderedType.t) * a;
      min_binding_opt :
        forall {a : Set} ,
      ...
      find :
        forall {a : Set}
          ...
          Ord.(RocqOfOCaml.OCamlMap.OrderedType.t) -> t a -> a;
      find_opt :
        forall {a : Set} ,
      ...
      to_seq :
        forall {a : Set} ,
          t a ->
          RocqOfOCaml.OCamlSeq.t (Ord.(RocqOfOCaml.OCamlMap.OrderedType.t) * a);
      to_rev_seq :
        forall {a : Set} ,
          t a ->
          RocqOfOCaml.OCamlSeq.t (Ord.(RocqOfOCaml.OCamlMap.OrderedType.t) * a);
